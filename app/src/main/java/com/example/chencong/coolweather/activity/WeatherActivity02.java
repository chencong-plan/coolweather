...
public class WeatherActivity02 extends Activity implements OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.switch_city:
                Intent intent = new Intent(this, ChooseAreaActivity_02.class);
                intent.putExtra("from_weather_activity", true);
                startActivity(intent);
                finish();
                break;
            case R.id.refresh_weather:
                publishText.setText("同步中数据...");
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(final String response) {
                if ("countyCode".equals(type)) {
                    ...
                    // 处理服务器返回的天气信息
                    Utility.handleWeatherRespone(WeatherActivity02.this, response);
